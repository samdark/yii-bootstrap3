...
Sin embargo, algunas marcas especiales de Bootstrap son cubiertas por el helper [[\Yiisoft\Yii\Bootstrap3\Html]].
[[\Yiisoft\Yii\Bootstrap3\Html]] es una versión mejorada de la regular [[\yii\helpers\Html]] dedicada a las necesidades de Bootstrap.
...
[[\Yiisoft\Yii\Bootstrap3\Html]] hereda todas las funcionalidades disponibles en [[\yii\helpers\Html]] y puede usarse como sustituto,
...
> Atención: no confundas [[\Yiisoft\Yii\Bootstrap3\Html]] con [[\yii\helpers\Html]], ten cuidado que clases estás usando dentro de tus vistas.
